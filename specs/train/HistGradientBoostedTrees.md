# Hist Gradient Boosted Trees Classifier
...
- Load model hyperparameters from YAML config file (`config/hist-gradient-{dataset}.yml`)
...
- [train/GradientBoostedTrees](GradientBoostedTrees.md) - Classic gradient boosted trees
